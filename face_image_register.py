...
def lookup_known_face(face_encoding):
    ...
    if face_distances[best_match_index] < 0.6:  # 얼굴 유사성이 0.5보다 작을 경우
...
def main_loop():
    ...
    frame = cv2.imread('/home/jae/PycharmProjects/web_gallery/images/IMG_20191225_194549_659.jpg'); #이미지 불러오기
    ...
    for face_location, face_encoding in zip(face_locations, face_encodings):
        ...
        for metadata in known_face_metadata:
            ...
            if datetime.now() - metadata["last_seen"] < timedelta(seconds=10) and metadata["seen_frames"] > 5:
                ...
                if visits == 1:
                    ...
                    visit_label = f"Register this Face"
                    # 얼굴 유사도를 보여주는 코드이다.
        ...
        dst = cv2.resize(frame, dsize=(720, 720), interpolation=cv2.INTER_AREA)
        cv2.imshow('reg', dst)
